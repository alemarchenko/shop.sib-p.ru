			...
			select.bind('change', function(){
				if(this.value=='new_prop')
				{
					...
					var dialog = new BX.CAdminDialog({
						...
						'content_url':'/bitrix/admin/'+kdaIEModuleFilePrefix+'_new_hlbl_field.php?lang='+BX.message('LANGUAGE_ID')+'&PARENT_FIELD_NAME='+escape(input.name)+'&HLBL_ID='+ptable.attr('data-iblock-id'),
						'width':'900',
						'height':'400',
						'resizable':true});
