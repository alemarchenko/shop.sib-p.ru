...
$arParams['~MESS_ECONOMY_INFO2'] = Loc::getMessage('RS_MM_BSPG_CATALOG_ECONOMY_INFO2');
$arParams['~MESS_ITEM_ARTNUMBER'] = Loc::getMessage('RS_MM_BSPG_CATALOG_ITEM_ARTNUMBER_MESSAGE');
...
if (strlen($arParams['RS_LIST_SECTION_TITLE']) > 0)
{
	$layout
		->addData('SECTION_ATTRIBUTES', ' id="'.$mainId.'" data-entity="parent-container" data-target="#l-main__nav" data-title="'.$arParams['RS_LIST_SECTION_TITLE'].'"');
}
else
{
	$layout
