...
$templateData['TEMPLATE_CLASS'] = 'bx-'.$arParams['TEMPLATE_THEME'];
...
?>
<div id="<?= $injectId ?>" class="sale-gift-main-products">
<?
if($arResult['HAS_MAIN_PRODUCTS'])
{
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'RS_LIST_SECTION_SHOW_TITLE' => !isset($arParams['SHOW_PARENT_TITLE']) || $arParams['SHOW_PARENT_TITLE'] !== 'N' ? 'Y' : 'N',
			'RS_LIST_SECTION_TITLE' => $arParams['RS_LIST_SECTION_TITLE'] ?: Loc::getMessage('CT_BCE_CATALOG_GIFT_BLOCK_TITLE_DEFAULT'),
		),
		$component,
		array('HIDE_ICONS' => 'Y')
	);
