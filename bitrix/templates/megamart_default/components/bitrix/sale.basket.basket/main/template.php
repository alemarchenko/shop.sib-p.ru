...
if ($arParams['USE_GIFTS'] === 'Y')
{
	...
	$giftParameters = array(
		...
		'RS_LIST_SECTION_TITLE' => $arParams['GIFTS_BLOCK_TITLE'],
	...
	{
		$giftParameters['DEFERRED_PRODUCT_ROW_VARIANTS'] = \Bitrix\Main\Web\Json::encode(
			\Redsign\MegaMart\ElementListUtils::predictRowVariants(
				$arParams['GIFTS_PAGE_ELEMENT_COUNT'],
				$arParams['GIFTS_PAGE_ELEMENT_COUNT']
			)
		);
