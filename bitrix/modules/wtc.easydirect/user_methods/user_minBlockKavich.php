<?
//field_NAME=По минимальной цене в блоке + учет кавычек
//field_FNAME=user_minBlockKavich
//field_TYPE=SEARCH
//field_IS_IMPORTANT=N
//field_DESCRIPTION=По минимальной цене в блоке. Если слово с кавычками, ставку увеличиваем на определенный % (10).
//field_SORT=500

$user_minBlockKavich= function($params)
{
    //------------------
