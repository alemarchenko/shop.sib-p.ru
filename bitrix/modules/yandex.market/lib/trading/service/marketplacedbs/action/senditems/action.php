...
class Action extends TradingService\Reference\Action\DataAction
{
	...
	public function process()
	{
		try
		{
			...
			$this->sendItems($items, $reason);
			$this->logItems($items, $reason);
	...
	protected function sendItems(array $items, $reason)
	{
		$request = $this->createSendItemsRequest($items, $reason);
	...
	protected function createSendItemsRequest(array $items, $reason)
	{
	...
	protected function logItems(array $items, $reason)
	{
		$logger = $this->provider->getLogger();
