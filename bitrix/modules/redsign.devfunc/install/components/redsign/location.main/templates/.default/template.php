...
<span class="b-topline-location" id="topline-location">
    <svg class="icon-svg"><use xlink:href="#svg-location-main"></use></svg><?=Loc::getMessage('RS_RLM_DEFAULT_YOUR_CITY');?>:
    <a href="<?=(isset($arParams['POPUP_URL']) ? $arParams['POPUP_URL'] : SITE_DIR.'mycity/')?>" title="<?=Loc::getMessage('RS_RLM_DEFAULT_SELECT');?>" data-type="ajax" class="b-topline-location__link">
        <?php
