...
<form action="" method="post" enctype="multipart/form-data" name="restore_profiles" id="restore_profiles">
	...
	<table width="100%">
		...
		<tr id="kda_restore_profile_list_row" style="display: none;">
			<td class="adm-detail-content-cell-l" valign="top"><?echo GetMessage("KDA_IE_RESTORE_PROFILE_CHOOSE");?>:</td>
			<td class="adm-detail-content-cell-r" valign="top">
				<div id="kda_restore_profile_list"></div>
			</td>
		</tr>
	</table>
</form>
