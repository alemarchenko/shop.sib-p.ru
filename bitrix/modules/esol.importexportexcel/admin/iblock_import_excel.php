	...
	?>
		...
		<tr class="kda-extra-mode-chbs-wrap<?if($sepMode){echo ' kda-extra-mode-chbs-wrap-active';}?>">
			...
			<td>
				...
				<a href="javascript:void(0)" onclick="EProfile.ShowExtraModeChbs(this)" class="kda-extra-mode-link" title="<?echo GetMessage("KDA_IE_ONLY_UPDATE_MODE_LINK"); ?>" <?if(!$OFFERS_IBLOCK_ID){echo 'style="display: none;"';}?>></a>
