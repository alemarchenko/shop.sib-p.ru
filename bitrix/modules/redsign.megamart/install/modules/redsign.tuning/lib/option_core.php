...
abstract class OptionCore implements Interfaces\OptionCoreInterface
{
    ...
    abstract public function getPainting();
	...
	public function sanitizeName($option) {
		return str_replace($this->UCWORD_DELIMETER, '', $this->ucwordsUnicode(str_replace('_', $this->UCWORD_DELIMETER, $option)));
	}
	...
	protected function ucwordsUnicode($str, $encoding = 'UTF-8') {
		...
		return ucwords($str, $this->UCWORD_DELIMETER);
	}
