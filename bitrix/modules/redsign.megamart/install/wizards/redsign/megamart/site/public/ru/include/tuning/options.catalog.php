...
$arParams['CATALOG_SECTION_TYPE'] = array(
    ...
    'VALUES' => array(
        'TYPE_1' => array(
            ...
            'CONTROL_ID' => 'type1',
            'HTML_VALUE' => 'type1',
			'IMAGE' => '#SITE_DIR#include/tuning/img/catalog_section_type1.png'
        ),
        'TYPE_2' => array(
            'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_CATALOG_SECTION_TYPE_2'),
            'CONTROL_ID' => 'type2',
            'HTML_VALUE' => 'type2',
			'IMAGE' => '#SITE_DIR#include/tuning/img/catalog_section_type2.png'
        ),
        'TYPE_3' => array(
            'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_CATALOG_SECTION_TYPE_3'),
            'CONTROL_ID' => 'type3',
            'HTML_VALUE' => 'type3',
			'IMAGE' => '#SITE_DIR#include/tuning/img/catalog_section_type3.png'
        ),
    ),
    'VIEW' => 'images',
	'GRID_SIZE_VALUE' => 4,
