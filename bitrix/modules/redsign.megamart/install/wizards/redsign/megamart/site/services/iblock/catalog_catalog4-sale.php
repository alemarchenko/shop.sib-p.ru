...
$IBLOCK_CATALOG_ID = 0;
if (isset($_SESSION["WIZARD_CATALOG_CATALOG_IBLOCK_ID"]))
{
	$IBLOCK_CATALOG_ID = (int)$_SESSION["WIZARD_CATALOG_CATALOG_IBLOCK_ID"];
	unset($_SESSION["WIZARD_CATALOG_CATALOG_IBLOCK_ID"]);
}
$IBLOCK_OFFERS_ID = 0;
if (isset($_SESSION["WIZARD_OFFERS_OFFERS_IBLOCK_ID"]))
{
	$IBLOCK_OFFERS_ID = (int)$_SESSION["WIZARD_OFFERS_OFFERS_IBLOCK_ID"];
}
