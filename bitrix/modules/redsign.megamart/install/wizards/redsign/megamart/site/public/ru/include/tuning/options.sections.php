...
$arParams['NEWS_TEMPLATE'] = array(
	...
	'VALUES' => array(
		'TILE' => array(
			...
			'HTML_VALUE' => 'tile',
			'IMAGE' => '#SITE_DIR#include/tuning/img/news_template_tile.png',
		),
		'LINE' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_TAB_BANNERS.TEMPLATE_LINE'),
			'CONTROL_ID' => 'news_template_line',
			'HTML_VALUE' => 'line',
			'IMAGE' => '#SITE_DIR#include/tuning/img/news_template_line.png',
		)
	),
	'VIEW' => 'images',
    'GRID_SIZE_VALUE' => 6,
...
$arParams['STAFF_TEMPLATE'] = array(
	...
	'VALUES' => array(
		'TILE' => array(
			...
			'HTML_VALUE' => 'type1',
			'IMAGE' => '#SITE_DIR#include/tuning/img/staff_template_tile.png',
		),
		'LINE' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_TAB_BANNERS.TEMPLATE_LINE'),
			'CONTROL_ID' => 'staff_template_line',
			'HTML_VALUE' => 'type2',
			'IMAGE' => '#SITE_DIR#include/tuning/img/staff_template_line.png',
		)
	),
	'VIEW' => 'images',
    'GRID_SIZE_VALUE' => 6,
...
$arParams['LICENSE_TEMPLATE'] = array(
	...
	'VALUES' => array(
		'COL' => array(
			...
			'HTML_VALUE' => 'col',
			'IMAGE' => '#SITE_DIR#include/tuning/img/files_template_col.png',
		),
		'LINE' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_TAB_BANNERS.TEMPLATE_LINE'),
			'CONTROL_ID' => 'license_template_line',
			'HTML_VALUE' => 'line',
			'IMAGE' => '#SITE_DIR#include/tuning/img/files_template_line.png',
		)
	),
	'VIEW' => 'images',
    'GRID_SIZE_VALUE' => 6,
