...
$arParams['MAIN_BANNER_TYPE'] = array(
	...
	'VALUES' => array(
		'UNDERLAY' => array(
			...
			'HTML_VALUE' => 'underlay',
			'IMAGE' => '#SITE_DIR#include/tuning/img/banner_type_1.png',
		),
		'WIDE' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_TAB_BANNERS.TYPE_WIDE'),
			'CONTROL_ID' => 'mb_wide',
			'HTML_VALUE' => 'wide',
			'IMAGE' => '#SITE_DIR#include/tuning/img/banner_type_2.png',
		),
		'CENTER' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_TAB_BANNERS.TYPE_CENTER'),
			'CONTROL_ID' => 'mb_center',
			'HTML_VALUE' => 'center',
			'IMAGE' => '#SITE_DIR#include/tuning/img/banner_type_3.png',
		),
		'CENTER_SIDEBANNERS' => array(
			...
			'IMAGE' => '#SITE_DIR#include/tuning/img/banner_type_4.png',
		)
	),
	'VIEW' => 'images',
    'GRID_SIZE_VALUE' => 6,
