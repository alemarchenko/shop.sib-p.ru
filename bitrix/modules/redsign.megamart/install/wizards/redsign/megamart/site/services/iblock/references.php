...
$dbHblock = HL\HighloadBlockTable::getList(
	array(
		"filter" => array("NAME" => "RedsignMegamartColorReference", "TABLE_NAME" => "b_hlbd_colorreference")
	)
);
if (!$dbHblock->Fetch())
{
	$data = array(
		'NAME' => 'RedsignMegamartColorReference',
		'TABLE_NAME' => 'b_hlbd_colorreference',
	);
...
$dbHblock = HL\HighloadBlockTable::getList(
	array(
		"filter" => array("NAME" => "RedsignMegamartBrandReference", "TABLE_NAME" => "b_hlbd_brandreference")
	)
);
if (!$dbHblock->Fetch())
{
	$data = array(
		'NAME' => 'RedsignMegamartBrandReference',
		'TABLE_NAME' => 'b_hlbd_brandreference',
	);
...
$dbHblock = HL\HighloadBlockTable::getList(
	array(
		"filter" => array("NAME" => "RedsignMegamartBrandReferenceBrands", "TABLE_NAME" => "b_hlbd_brandreferencebrands")
	)
);
if (!$dbHblock->Fetch())
{
	$data = array(
		'NAME' => 'RedsignMegamartBrandReferenceBrands',
	...
	if ($result->isSuccess())
	{
		...
		$_SESSION["ESHOP_HBLOCK_BRAND_BRANDS_ID"] = $ID;
...
$dbHblock = HL\HighloadBlockTable::getList(
	array(
		"filter" => array("NAME" => "RedsignMegamartFeatureFilterReference", "TABLE_NAME" => "b_hlbd_featurefilterreference")
	)
);
if (!$dbHblock->Fetch())
{
	$data = array(
		'NAME' => 'RedsignMegamartFeatureFilterReference',
		'TABLE_NAME' => 'b_hlbd_featurefilterreference',
	);
	...
	if ($result->isSuccess())
	{
		...
		$_SESSION["ESHOP_HBLOCK_FEATURE_FILTER_ID"] = $ID;
		...
		$arUserFields = array (
			...
			array (
				...
				'FIELD_NAME' => 'UF_DESCRIPTION',
				'USER_TYPE_ID' => 'string',
				'XML_ID' => 'UF_FEATURE_FILTER_DESCR',
				'SORT' => '700',
				'MULTIPLE' => 'N',
				'MANDATORY' => 'N',
				'SHOW_FILTER' => 'N',
			...
			array (
				...
				'FIELD_NAME' => 'UF_FULL_DESCRIPTION',
				'USER_TYPE_ID' => 'string',
				'XML_ID' => 'UF_FEATURE_FILTER_FULL_DESCR',
				'SORT' => '800',
				'MULTIPLE' => 'N',
				'MANDATORY' => 'N',
				'SHOW_FILTER' => 'N',
