...
$arParams['POPUP_TYPE'] = array(
    ...
    'VALUES' => array(
        'TEMPLATE_1' => array(
            ...
            'CONTROL_ID' => 'window',
            'HTML_VALUE' => 'window',
            'IMAGE' => '#SITE_DIR#include/tuning/img/popup_type_1.png',
        ),
        'TEMPLATE_2' => array(
            'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_POPUP_TYPE.PANEL'),
            'CONTROL_ID' => 'side',
            'HTML_VALUE' => 'side',
            'IMAGE' => '#SITE_DIR#include/tuning/img/popup_type_2.png',
        ),
    ),
    'VIEW' => 'images',
    'GRID_SIZE_VALUE' => 6,
...
$arParams['SEARCH_POPUP'] = array(
    ...
    'VALUES' => array(
        'TOP' => array(
            ...
            'HTML_VALUE' => 'top',
            'IMAGE' => '#SITE_DIR#include/tuning/img/search_popup_top.png',
        ),
        'FUKK' => array(
            'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_SEARCH_POPUP.FULL'),
            'CONTROL_ID' => 'search_popup_full',
            'HTML_VALUE' => 'full',
            'IMAGE' => '#SITE_DIR#include/tuning/img/search_popup_full.png',
        )
    ),
    'VIEW' => 'images',
    'GRID_SIZE_VALUE' => 6,
