...
$IBLOCK_CATALOG_ID = (isset($_SESSION["WIZARD_CATALOG_CATALOG_IBLOCK_ID"]) ? (int)$_SESSION["WIZARD_CATALOG_CATALOG_IBLOCK_ID"] : 0);
$IBLOCK_OFFERS_ID = (isset($_SESSION["WIZARD_OFFERS_OFFERS_IBLOCK_ID"]) ? (int)$_SESSION["WIZARD_OFFERS_OFFERS_IBLOCK_ID"] : 0);
//reference update
...
WizardServices::IncludeServiceLang("catalog3.php", $languageID);

if ($IBLOCK_OFFERS_ID)
{
	$iblockCodeOffers = "redsign_megamart_offers_offers_".WIZARD_SITE_ID;
	//IBlock fields
	$iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
...
{
	$iblockCode = "redsign_megamart_catalog_catalog_".WIZARD_SITE_ID;
	//IBlock fields
	$iblock = new CIBlock;
	$arFields = Array(
		"ACTIVE" => "Y",
	...
	$arUserFields = array("UF_BROWSER_TITLE", "UF_KEYWORDS", "UF_META_DESCRIPTION", "UF_SECTION_ICON", "UF_MENU_TYPE", "UF_SECTION_COLOR", "UF_FEATURED_FILTER", "UF_DEALS_REF", "UF_BANNER_IMAGE", "UF_BANNER_LINK");
...
//demo discount
	...
	if (empty($row))
	{
		...
		{
			$dbSect = CIBlockSection::GetList(Array(), Array("IBLOCK_TYPE" => "catalog", "IBLOCK_ID"=>$IBLOCK_CATALOG_ID, "CODE" => "elektronika", "IBLOCK_SITE_ID" => WIZARD_SITE_ID));
...
*/
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax/wishlist.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/brands/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/catalog/.mainsub.menu_ext.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/compact/search.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/global/compare.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/header/search_form.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/header/search_popup.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/index/popular_sections.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/index/products.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/index/viewed_items.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/templates/articles/catalog_items.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/templates/news/catalog_items.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/templates/sale/catalog_items.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/personal/wishlist/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/personal/search/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/personal/order/make/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID, "OFFERS_OFFERS_IBLOCK_ID" => $IBLOCK_OFFERS_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/search/index.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
	CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH.".catalog.menu_ext.php", array("CATALOG_CATALOG_IBLOCK_ID" => $IBLOCK_CATALOG_ID));
}
?>