...
$arParams['FIX_HEADER'] = array(
	...
	'VALUES' => array(
		'ENABLED' => array(
			...
			'HTML_VALUE' => 'Y',
			'IMAGE' => '#SITE_DIR#include/tuning/img/fix_header_enabled.png',
		),
		'DISABLED' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_FIX_HEADER.DISABLED'),
			'CONTROL_ID' => 'fix_header_disabled',
			'HTML_VALUE' => 'N',
			'IMAGE' => '#SITE_DIR#include/tuning/img/fix_header_disabled.png',
		)
	),
	'VIEW' => 'images',
	'GRID_SIZE_VALUE' => 4,
...
$arParams['HEADER_TYPE'] = array(
	...
	'VALUES' => array(
		'HEADER_1' => array(
			...
			'CONTROL_ID' => 'header_1',
			'HTML_VALUE' => 'type1',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_1.png',
		),
		'HEADER_2' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.2'),
			'CONTROL_ID' => 'header_2',
			'HTML_VALUE' => 'type2',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_2.png',
		),
		'HEADER_3' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.3'),
			'CONTROL_ID' => 'header_3',
			'HTML_VALUE' => 'type3',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_3.png',
		),
		'HEADER_4' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.4'),
			'CONTROL_ID' => 'header_4',
			'HTML_VALUE' => 'type4',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_4.png',
		),
		'HEADER_5' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.5'),
			'CONTROL_ID' => 'header_5',
			'HTML_VALUE' => 'type5',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_5.png',
		),
		'HEADER_6' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.6'),
			'CONTROL_ID' => 'header_6',
			'HTML_VALUE' => 'type6',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_6.png',
		),
		'HEADER_7' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.7'),
			'CONTROL_ID' => 'header_7',
			'HTML_VALUE' => 'type7',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_7.png',
		),
		'HEADER_8' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.9'),
			'CONTROL_ID' => 'header_8',
			'HTML_VALUE' => 'type8',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_8.png',
		),
		'HEADER_9' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.9'),
			'CONTROL_ID' => 'header_9',
			'HTML_VALUE' => 'type9',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_9.png',
		),
		'HEADER_10' => array(
			'NAME' => Loc::getMessage('RS_MM_TUNING_PARAM_HEADER.10'),
			'CONTROL_ID' => 'header_10',
			'HTML_VALUE' => 'type10',
			'IMAGE' => '#SITE_DIR#include/tuning/img/header_10.png',
		),
	),
	'VIEW' => 'images',
	'NUMBERS' => 'Y',
