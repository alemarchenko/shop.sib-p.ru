...
CopyDirFiles(
	$_SERVER["DOCUMENT_ROOT"].WizardServices::GetTemplatesPath(WIZARD_RELATIVE_PATH."/site")."/.default",
...
*/
if (!in_array($wizrdTemplateId, array("megamart")))
	$wizrdTemplateId = "megamart";
...
elseif(WIZARD_INSTALL_DEMO_DATA || !file_exists(WIZARD_SITE_PATH."/include/header/logo.php")/* && !file_exists(WIZARD_SITE_PATH."/include/logo.png")*/)
{
