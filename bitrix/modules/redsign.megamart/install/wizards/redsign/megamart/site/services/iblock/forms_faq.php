...
if(COption::GetOptionString("redsign.megamart", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
{
	...
	{
		$iblockCode = "redsign_megamart_forms_faq_".WIZARD_SITE_ID;
		$iblockType = "forms";
		...
		{
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/faq/index.php", array("FORMS_FAQ_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
WizardServices::IncludeServiceLang("forms_faq.php", $lang);
