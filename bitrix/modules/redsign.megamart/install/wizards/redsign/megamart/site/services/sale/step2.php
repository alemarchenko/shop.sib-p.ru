...
if(COption::GetOptionString("redsign.megamart", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
	$arLocationArr = Array();
...
COption::SetOptionString("redsign.megamart", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>