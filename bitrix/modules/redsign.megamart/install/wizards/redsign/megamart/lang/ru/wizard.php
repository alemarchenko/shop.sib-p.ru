...
$MESS["WIZ_TEMPLATE_ADAPT_HORIZONTAL"] = "MegaMart: адаптивный шаблон (по умолчанию)";
...
$MESS["WIZ_COMPANY_TELEPHONE_DEF"] = "8 (000) 000 00 00";
...
$MESS["WIZ_COMPANY_ADDRESS_DEF"] = "Проспект мира, д. 1а";
$MESS["WIZ_COMPANY_COPY"] = "Подпись сайта";
$MESS["WIZ_MAP_SERVICE"] = "Картографический сервис";
$MESS["WIZ_MAP_SERVICE_YANDEX"] = "Yandex.Карты";
$MESS["WIZ_MAP_SERVICE_GOOGLE"] = "Google Maps";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; Все права защищены. Информация сайта защищена законом об авторских правах.";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"MegaMart\"";
$MESS["WIZ_SHOP_OF_NAME_DEF_UA"] = "ТОВ \"MegaMart\"";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"MegaMart\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["wiz_site_desc"] = "Мы предлагаем широкий ассортимент товаров по адекватным ценам.";
$MESS["wiz_keywords"] = "активный отдых, спортивные товары, велосипеды, скейтборды, лыжи, одежда";
...
$MESS["WIZ_STEP_HOMEPAGE_TITLE"] = "Выбор главной страницы";
$MESS["WIZ_STEP_HOMEPAGE_SUBTITLE"] = "Выбор структуры главной страницы сайта";
$MESS["wiz_template_homepage"] = "Выберите главную страницу сайта";
